...
export const DashboardCardWidgets = [
    ...
    { icon: FolderKanban, value: 310, change: "+8.72%", label: "Project Plans" },
    { icon: CheckCircle, value: 310, change: "+8.72%", label: "Habits" },
    { icon: Quote, value: 310, change: "+8.72%", label: "Today's Quote" },
];
